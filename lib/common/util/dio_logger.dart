...
class PrettyDioLogger extends Interceptor {
  ...
  /// Print auth_request [Options]
  final bool request;

  /// Print auth_request header [Options.headers]
  final bool requestHeader;

  /// Print auth_request data [Options.file]
  ...
  /// InitialTab count to logPrint json auth_response
  static const int initialTab = 1;

  /// 1 tab length
  static const String tabStep = '    ';

  /// Print compact json auth_response
  final bool compact;
